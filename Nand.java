 ...
 * @author SAGIV ANTEBI
 * A class of Nand
 * The class extends BinaryExpression and is the 'Nand' logical expressin
 */
public class Nand extends BinaryExpression {
     ...
     */
    public Nand(Expression val1, Expression val2) {
        super(val1, val2);
    }
    ...
    public String toString() {
        return "(" + super.getExp1().toString() + " A " + super.getExp2().toString() + ")";
    }
    ...
    public Expression norify() {
        return new Nor(new Nor(new Nor(super.getExp1().norify(), super.getExp1().norify()),
                ...
                new Nor(new Nor(super.getExp1().norify(), super.getExp1().norify()),
                        new Nor(super.getExp2().norify(), super.getExp2().norify())));
    }
        ...
        try {
            ...
            try {
                if (getExp1().toString().equals(getExp2().toString())) {
                    ...
                    return new Nand(exp1Simplified, exp2Simplified);
                }
            } catch (Exception e) {
            }
            ...
            try {
                Nand x = new Nand(exp1Simplified, exp2Simplified);
